...
public class NombreApellidoValidator implements ConstraintValidator<ValidApellidoNombre, String> {

    @Override
    public void initialize(ValidApellidoNombre constraintAnnotation) {}
